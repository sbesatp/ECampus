...
var gbAutoClose=true;	// whether to close the calendar after selecting a date.//surya-false
...
var gBegin=[1950,1,1];	// calendar date range begin from [Year,Month,Date]. Using Daypop here will make it start from today.
var gEnd=[2050,12,31];	// calendar date range end at [Year,Month,Date]
var gsOutOfRange="Sorry, you may not go beyond the designed range!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
var guOutOfRange=null;	// the background image url for the out-range dates. e.g. "outrange.gif"

//var giFirstDOW=5;	// indicates the first day of week. 0:Sunday; 1-6:Monday-Saturday.//surya-0
var giFirstDOW=0;   //Modified By Chinna Babu On 31-Oct-2007
...
var gcCalFrame="#2B85BC";	// the background color of the inner table, showing as a frame.//surya-#e8f0f4
...
var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.surya-false
var gsBottom="we assigned the value of gsBottom in timehandler.js";
...
var gcCellBG="#E4F5FA";	// default background color of the cells. Use "" for transparent!!! Surya-#d8e0e4
var gsCellHTML="";	// default HTML contents for days without any noholidays, usually an image tag.
...
var gcFGToday="Blue";	// the font color for today //white-surya
var gcBGToday="Yellow";	// the background color for today //#D4D0C8-surya
var guTodayBGImg="";	// url of image as today's background
var giMarkToday=8; // Effects for today - 0: nothing; 1: set background color with gcBGToday; 2: draw a box with gcBGToday; 4: bold the font; 8: set font color with gcFGToday; 16: set background image with guTodayBGImg; - they can be added up to create mixed effects.//2-surya
...
var gAgendaMask=[-1,-1,gcCellBG,"black",-1,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original noholidays/event value of that bit intact. Any other value will be used to override the original one defined in noholidays.js. Check the tutorial for details.
...
var gbFlatBorder=false;	// flat the .CalCell css border of any noholidays date by setting it to solid style. NOTE: it should always be set to false if .CalCell has no explicit border size.
var gbInvertBorder=false;	// true: invert the effect caused by gbFlatBorder; false: no change.
var gbShareAgenda=false;	// if set to true, a global noholidays store will be created and used to share across calendars. Check tutorials for details.
var gsAgShared="gContainer._cxp_agenda";	// shared noholidays store name used when gbShareAgenda is true.
var gbCacheAgenda=false;	// false: will prevent the noholidays url from being cached; true: cached as normal js file.
