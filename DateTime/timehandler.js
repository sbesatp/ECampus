...
function fFormatInput(y,m,d) {
	...
	if(gbHideBottom)
	{
	return fFormatDate(y,m,d)//surya-
	
	}
	else return fFormatDate(y,m,d)+_separator_datetime+_timeVal;
}

function fchktime(name)
{
//alert(document.getElementById("outerTable").height);
if(name.checked)
{
...
{
document.getElementById("tdtime").style.display="block";
